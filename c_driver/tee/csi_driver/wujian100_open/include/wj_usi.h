...
#define USI_MODE_SPI     0x2   //具体的模式选择在这里
...
//从基地址偏移的区域就是该设备下所属的寄存器地址区域
typedef struct {
    __IOM uint32_t USI_EN;                 /* Offset 0x000(R/W) */  //USI CTRL 
    __IOM uint32_t USI_MODE_SEL;           /* Offset 0x004(R/W) */
    __IOM uint32_t USI_TX_RX_FIFO;         /* Offset 0x008(R/W) */ // TX_FIFO, RX_FIFO 
