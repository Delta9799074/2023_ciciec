...
#define CONFIG_MBX_CH0_NUM 1
#define CONFIG_MBX_CH1_NUM 1

#define CONFIG_IOPMP_NUM 1
...
#define MBX_CH0_BASE              (0x40030008UL)
#define MBX_CH1_BASE              (0x40100014UL)

#define IOPMP_BASE                (0x40100020UL)
typedef enum {
    WJENUM_DMA_UART0_RX,
    WJENUM_DMA_UART0_TX,
    WJENUM_DMA_UART1_RX,
