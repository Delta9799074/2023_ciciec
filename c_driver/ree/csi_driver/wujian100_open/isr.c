...
extern void mbx_ch0_irqhandler(int idx);
extern void mbx_ch1_irqhandler(int idx);
extern void iopmp_irqhandler(int idx);
...
ATTRIBUTE_ISR void MBX_CH0_IRQHandler(void)
{
    CSI_INTRPT_ENTER();
    mbx_ch0_irqhandler(0);
    CSI_INTRPT_EXIT();
}

ATTRIBUTE_ISR void MBX_CH1_IRQHandler(void)
{
    CSI_INTRPT_ENTER();
    mbx_ch1_irqhandler(0);
    CSI_INTRPT_EXIT();
}

ATTRIBUTE_ISR void IOPMP_IRQHandler(void)
{
    CSI_INTRPT_ENTER();
    iopmp_irqhandler(0);
    CSI_INTRPT_EXIT();
