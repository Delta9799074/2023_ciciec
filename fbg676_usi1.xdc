...
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports PAD_USI0_SCLK]
set_property -dict {PACKAGE_PIN R8 IOSTANDARD LVCMOS33} [get_ports PAD_USI0_SD0]
...
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports PAD_USI1_SD0]
set_property -dict {PACKAGE_PIN F23 IOSTANDARD LVCMOS33} [get_ports PAD_USI1_SCLK]
